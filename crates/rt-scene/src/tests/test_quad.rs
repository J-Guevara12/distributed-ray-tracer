...
fn test_quad_miss_outside_bounds() {
    ...
    let ray = Ray::new(Point3::new(1.5, 0.0, 0.0), Vec3::new(0.0, 0.0, -1.0));
    let interval = Interval::new(0.001, 10.0);
...
fn test_quad_hit_edges_and_corners() {
    ...
    let ray_q = Ray::new(Point3::new(-1.0, -1.0, 0.0), Vec3::new(0.0, 0.0, -1.0));
    assert!(
    ...
    let ray_opposite = Ray::new(Point3::new(1.0, 1.0, 0.0), Vec3::new(0.0, 0.0, -1.0));
    assert!(
